            ...
            <ImageBackground source={background} resizeMode="cover" style={styles.image}>
                <View style={styles.content}>
                    ...
                    <View style={styles.button}>
                        <Button icon="camera" color={colors.primary} labelStyle={{color: 'white'}} mode="contained" onPress={() => console.log('Pressed')}>
                            Repas
                        </Button>
                        <Button icon="camera" style={styles.but} mode="contained" onPress={() => console.log('Pressed')}>
                            Boisson
                        </Button>
                        <Button icon="camera" style={styles.but} mode="contained" onPress={() => console.log('Pressed')}>
                            Dessert
